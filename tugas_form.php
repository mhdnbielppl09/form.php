...
<form class="form-horizontal" nama="f1" method="POST" action="form_table.php">
...
<div class="form-group">
  ...
  <div class="col-md-8">
    <div class="input-group">
      ...
      <input id="prependedtext" name="prependedtext" class="form-control" placeholder="MOHAMMED NABIEL" type="text" required="">
    </div>
...
<div class="form-group">
  ...
  <div class="col-md-8">
  <input id="textinput" name="textinput" type="text" placeholder="18" class="form-control input-md" required="">
